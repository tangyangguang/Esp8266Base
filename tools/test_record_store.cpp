...
int main() {
    ...
    assert(Store::readPrevious(UINT64_MAX,id,output,sizeof(output)) && id==5);
    assert(Store::readPrevious(id,id,output,sizeof(output)) && id==4);
    assert(Store::readPrevious(3,id,output,sizeof(output))==false && id==0);
    assert(Store::readPrevious(0,id,output,sizeof(output))==false && id==0);
