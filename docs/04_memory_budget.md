...
| `sleep_watchdog` | Sleep + WDT | 33,156B | 314,651B |
| `custom_web` | Web + mDNS + WDT | 38,188B | 390,148B |
| `wifi_config_ota` | Web + OTA + NTP + mDNS + WDT | 40,476B | 410,384B |
| `full_demo` | Web + OTA + NTP + mDNS + Sleep + WDT | 42,508B | 418,960B |
