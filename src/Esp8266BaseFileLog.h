...
//
// 运行模式只支持 OFF / ERROR / WARN / INFO。路径、单段大小、轮转段数、buffer
// 和 flush interval 都是构建期资源策略，不作为 Web 普通运维配置。
// ----------------------------------------------------------------------------

#define ESP8266BASE_FILELOG_MODE_OFF  4
#define ESP8266BASE_FILELOG_MODE_ERROR 3
...
#if ESP8266BASE_FILELOG_DEFAULT_MODE != ESP8266BASE_FILELOG_MODE_OFF && ESP8266BASE_FILELOG_DEFAULT_MODE != ESP8266BASE_FILELOG_MODE_ERROR && ESP8266BASE_FILELOG_DEFAULT_MODE != ESP8266BASE_FILELOG_MODE_WARN && ESP8266BASE_FILELOG_DEFAULT_MODE != ESP8266BASE_FILELOG_MODE_INFO
#error "ESP8266BASE_FILELOG_DEFAULT_MODE must be ESP8266BASE_FILELOG_MODE_OFF, ESP8266BASE_FILELOG_MODE_ERROR, ESP8266BASE_FILELOG_MODE_WARN, or ESP8266BASE_FILELOG_MODE_INFO"
#endif
